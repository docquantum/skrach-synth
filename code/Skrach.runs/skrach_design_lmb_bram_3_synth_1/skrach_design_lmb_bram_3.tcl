...
synth_design -top skrach_design_lmb_bram_3 -part xc7a200tsbg484-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix skrach_design_lmb_bram_3_ skrach_design_lmb_bram_3.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ skrach_design_lmb_bram_3_stub.v
 lappend ipCachedFiles skrach_design_lmb_bram_3_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ skrach_design_lmb_bram_3_stub.vhdl
 lappend ipCachedFiles skrach_design_lmb_bram_3_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ skrach_design_lmb_bram_3_sim_netlist.v
 lappend ipCachedFiles skrach_design_lmb_bram_3_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ skrach_design_lmb_bram_3_sim_netlist.vhdl
 lappend ipCachedFiles skrach_design_lmb_bram_3_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp skrach_design_lmb_bram_3.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips skrach_design_lmb_bram_3]
}

rename_ref -prefix_all skrach_design_lmb_bram_3_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef skrach_design_lmb_bram_3.dcp
