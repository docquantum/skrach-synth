...
#
# Generated by export_simulation on Sun Apr 12 23:39:31 CDT 2020
#
################################################################################
...
'-reset_run' switch to the './lab4_design.sh' script.

./lab4_design.sh -reset_run
...
./lab4_design.sh -noclean_files

For more information on the script, please type './lab4_design.sh -help'.
